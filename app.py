...
st.write("## Uplode a picture that contains a face " + ":camera:")
...
if photo:
    ...
    for bbox in b_boxes:
        ...
        with open('result.jpeg', "rb") as file:
            btn = st.download_button(label = "ดาวน์โหลดรูปภาพ", data = file, file_name = "image_text.jpg")
            if btn:
